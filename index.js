const contentLetterSrart_actived =
  "Có lẽ mình là người chúc cậu cuối cùng rồi vì đã trễ hẳn qua ngày mới, mình rất là xin lũi huhu :(((."; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Chúc cậu tuổi mới sẽ luôn giữ được nụ cười trên môi vì tớ thấy cậu cười đẹp vã ò =))), chúc cậu luôn mạnh khỏe, may mắn, thành công trong công việc và hạnh phúc bên những người mà cậu yêu thương, Happy birthday to you!!!."; //Nội dung của bức thư
